...
export default function AuthScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const { getRoleDashboard } = await import("@/lib/auth-context");
  ...
  const handleRegister = async () => {
    ...
    try {
      const { res, data } = await registerAPI(nama, email, password);
            ...
            <View style={styles.form}>
              ...
              <Field label="Kata Sandi">
                ...
                <View style={styles.passwordHints}>
                  ...
                  <Text style={styles.hint}>• Wajib mengandung minimal satu huruf kapital (A-Z)</Text>
                </View>
              </Field>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: "#f6f9fe" },
  scrollContent: { paddingHorizontal: 28, paddingTop: 20, paddingBottom: 48 },
  ...
  brandName: { fontSize: 18, color: "#1d4ed8", fontFamily: Platform.OS === "ios" ? "Georgia" : "serif", fontWeight: "500" },
  headingBlock: { marginBottom: 24 },
  heading: { fontSize: 28, fontWeight: "700", color: "#111827", letterSpacing: -0.5, marginBottom: 6 },
  subheading: { fontSize: 15, color: "#6b7280", lineHeight: 22 },
  tabBar: {
    flexDirection: "row", backgroundColor: "rgba(226,232,240,0.5)", borderRadius: 12,
    padding: 4, marginBottom: 20, position: "relative", height: 44,
  },
  tabPill: {
    position: "absolute", top: 4, width: "48%", height: 36, backgroundColor: "#ffffff",
    borderRadius: 9, shadowColor: "#000", shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.08, shadowRadius: 4, elevation: 2,
  },
  tabBtn: { flex: 1, alignItems: "center", justifyContent: "center", zIndex: 10 },
  tabLabel: { fontSize: 14, fontWeight: "500", color: "#94a3b8" },
  tabLabelActive: { color: "#1d4ed8" },
  banner: { borderRadius: 10, padding: 14, marginBottom: 16, borderWidth: 1 },
  bannerError: { backgroundColor: "#fef2f2", borderColor: "#fecaca" },
  bannerSuccess: { backgroundColor: "#f0fdf4", borderColor: "#bbf7d0" },
  bannerTextError: { color: "#dc2626", fontSize: 13 },
  bannerTextSuccess: { color: "#16a34a", fontSize: 13 },
  form: { gap: 16 },
  fieldWrap: { gap: 6 },
  fieldLabel: { fontSize: 11, fontWeight: "600", color: "#6b7280", letterSpacing: 1.2, textTransform: "uppercase" },
  input: {
    height: 48, backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#e2e8f0",
    borderRadius: 8, paddingHorizontal: 16, fontSize: 15, color: "#111827",
  },
  ...
  passwordHints: { marginTop: 6, gap: 2 },
  hint: { fontSize: 11, color: "#94a3b8", lineHeight: 16 },
  submitBtn: {
    height: 48, backgroundColor: "#2563eb", borderRadius: 8, flexDirection: "row",
    alignItems: "center", justifyContent: "center", marginTop: 6,
    shadowColor: "#2563eb", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25,
    shadowRadius: 8, elevation: 4,
  },
  submitBtnDisabled: { opacity: 0.6 },
  submitLabel: { color: "#ffffff", fontSize: 14, fontWeight: "600", letterSpacing: 0.3 },
  footer: { marginTop: 32, textAlign: "center", fontSize: 11, color: "#9ca3af", lineHeight: 17, paddingHorizontal: 16 },
