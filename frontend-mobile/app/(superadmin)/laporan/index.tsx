...
export default function SuperAdminLaporanListScreen() {
  ...
  const renderItem = ({ item }: { item: any }) => (
    <TouchableOpacity style={styles.card} onPress={() => router.push(`/(superadmin)/laporan/${item.id}` as any)} activeOpacity={0.7}>
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Laporan Pengaduan</Text>
      </View>
