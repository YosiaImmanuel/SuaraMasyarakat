...
import { fetchLaporan, fetchCategories } from "@/lib/api";
...
export default function UserLaporanListScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.addBtn} onPress={() => router.push("/(user)/laporan/create" as any)}>
