...
router.post('/',          verifyToken, upload.array('gambar[]', 10), uploadErrorHandler, laporanController.create);
router.put('/:id',        verifyToken, upload.array('gambar[]', 10), uploadErrorHandler, laporanController.update);
